 ...
 *
 *	@return 1 This cache depends on a lower layer cache. The unique ID of the re-requisite cache is found in ccToUse as metadata or needs to be stored as metadata.
